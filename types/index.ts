...
export interface Property {
  ...
  category: string;
  type: string;
  sub_type?: string | null; // 'sub_type' is optional (required: false)
  state: string;
  locality: string;
  sub_locality: string;
  listdate: Date;
  image: string; // Assuming the image field is a URL or file path
  gallery: string[]; // An array of strings, assuming gallery contains URLs or file paths
}
